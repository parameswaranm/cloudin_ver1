            ...
            <div className="col-md-9">
              <nav className="techno_menu">
                ...
                <ul className="sub-menu">
                  ...
                  <li>
                    <NavLink activeClassName="active" to="/investor">Investor</NavLink>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <ul className="sub-menu">
                      <li>
                      <NavLink activeClassName="active" to="/ai">Artificial Intelligence</NavLink>
                      </li>
                      <li>
                      <NavLink activeClassName="active" to="/mLnNLP">ML & NLP</NavLink>
                      </li>
                      <li>
                      <NavLink activeClassName="active" to="/blockchain">Blockchain</NavLink>
                      </li>
                      <li>
                      <NavLink activeClassName="active" to="/chatBot">Chat bot</NavLink>
                      </li>
                      <li>
                      <NavLink activeClassName="active" to="/aWSnAzure">AWS & Azure</NavLink>
                      </li>
                      <li>
                      <NavLink activeClassName="active" to="/react">React</NavLink>
                      </li>
                      <li>
                      <NavLink activeClassName="active" to="/iTConsulting">IT Consulting</NavLink>
                      </li>
                      <li>
                      <NavLink activeClassName="active" to="/mobileApp">Mobile App</NavLink>
                      </li>
                      <li>
                      <NavLink activeClassName="active" to="/webApp">Web App</NavLink>
                      </li>
                      <li>
                      <NavLink activeClassName="active" to="/uiux">UI/UX Design</NavLink>
                      </li>
